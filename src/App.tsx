...
import NumberReducerComponent from './NumberReducerComponent';
...
/** Instructions
   ...
   */
   ...
   /*
    Assumtions Made: 
       3.1 - Maintaining removed users as a separate state is mandatory, 
            even though deleted users can be retained in the 'users' state using an 'isDeleted' flag, making it more convenient for searching and restoring deleted users (3.5).
      4.4. - TO mantain count > 0 a check and alert has beeen added. 
